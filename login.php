...
<head>
  ...
  <title>Login-Hombre Poerte</title>
      ...
      <div class="row">
        <div class="col-sm-6 login-section-wrapper">
          ...
          <div class="login-wrapper my-auto">
            ...
            <p class="login-wrapper-footer-text">Don't have an account? <a href="register.php"
                class="text-reset">Register here</a></p>
          </div>
        </div>
        <div class="col-sm-6 px-0 d-none d-sm-block">
          <img src="images/about-img.jpg" alt="login image" class="login-img">
        </div>
      </div>
    </div>
  </main>
